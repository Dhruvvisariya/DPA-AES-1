...
def main():
    # Parameters
    num_traces = 100
    samples_per_cycle = 50  # Adjust for more/fewer points per operation
    noise_level = 0.05
    amplitude_scale = 2.0  # Increase amplitude to get negative values
